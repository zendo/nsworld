...
;;; $DOOMDIR/init.el -*- lexical-binding: t; no-byte-compile: t; -*-
(doom! :input
       ;;chinese
       ;;japanese
...
#+begin_src emacs-lisp
; doom 弹出窗口规则
(set-popup-rule! "^\\*eat" :side 'bottom :height 0.4 :quit t :select t)
#+end_src

** ghostel
#+begin_src emacs-lisp
(require 'ghostel nil t)
(set-popup-rule! "^\\*ghostel" :side 'bottom :size 0.4)
#+end_src
