...
;; (add-hook 'after-init-hook #'display-time-mode) ;显示时间
...
** parens
#+begin_src emacs-lisp
(add-hook 'after-init-hook #'show-paren-mode)    ;括号匹配 parens
...
(use-package recentf
  ...
  (recentf-exclude
   (list "\\.tar$" "\\.tbz2$" "\\.tbz$" "\\.tgz$" "\\.bz2$"
         "\\.bz$" "\\.gz$" "\\.gzip$" "\\.xz$" "\\.zip$"
         "\\.7z$" "\\.rar$"
         "COMMIT_EDITMSG\\'" "persp-auto-save"
...
(use-package cape
  ...
  (add-hook 'completion-at-point-functions #'cape-symbol) ;elisp symbol
