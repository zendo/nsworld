{
  ...
  gi-crystal = {
    ...
    rev = "v0.14.0";
    sha256 = "1d63g6bmfqg1xq5199lfjypgbz841jpzzmmd0dc27q88jaqsiaqq";
  };
  gtk4 = {
    url = "https://github.com/hugopl/gtk4.cr.git";
    rev = "v0.12.0";
    sha256 = "1y9b839w4880yfy7bhixp9qkc4k19016j91311bzjxgadx2m1y8l";
  };
  libadwaita = {
    url = "https://github.com/geopjr/libadwaita.cr.git";
    rev = "840e2a37c606c6970fbe299f53ee080c75fc09fa";
    sha256 = "1jzy6hm6cwkq4iav0zc4fklimm85c6fz8j24m93845g0w9mcpbf6";
  };
  non-blocking-spawn = {
